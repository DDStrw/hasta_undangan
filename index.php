<?php 
  ...
  <!-- Mirrored from satumomen.com/preview/wayang-kulit by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 May 2024 10:53:56 GMT -->
  <!-- Added by HTTrack -->
  ...
  <head>
    ...
    <title>Inaugurasi R.S. Bhayangkara TK.III Hasta Brata Batu</title>
    <meta name="title" content="Inaugurasi R.S. Bhayangkara TK.III Hasta Brata Batu">
    <meta name="description" content="">
    <meta itemprop="image" content="assets.satumomen.com/images/galleries/27214-gallery-1671893993.jpg">
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="index.html">
    <meta property="og:title" content="Inaugurasi R.S. Bhayangkara TK.III Hasta Brata Batu">
    <meta property="og:description" content="">
    <meta property="og:image" content="assets.satumomen.com/images/galleries/27214-gallery-1671893993.jpg">
    ...
    <script type="application/ld+json">
          {
            ...
            "@type": "Product", 
            "name": "Wedding &amp; Engagement  - Wayang Kulit",
            "image": "https://satumomen.com/themes/wayang-kulit/wayang-kulit.jpg",
            "description": "Tema undangan digital website custom by Satu Momen",
            "brand": {
              "@type": "Brand",
              "name": "Satu Momen"
            },
    ...
    <link rel="stylesheet" type="text/css" href="unpkg.com/%40phosphor-icons/web%402.0.3/src/fill/style.css" />
    <link href="themes/themesv28603.css?v=080340" rel="stylesheet">
    <style>
      @import url('fonts/brittany_signature/BrittanySignature.css');
      @import url('https://fonts.googleapis.com/css2?family=Arsenal:ital,wght@0,400;0,700;1,400;1,700&amp;family=DM+Serif+Display:ital@0;1&amp;display=swap');
      ...
      :root {
        ...
        --inv-accent: #956625;
        --inv-border: #F6F6F6;
        --font-base: 'Arsenal', sans-serif;
        --font-accent: 'DM Serif Display', serif;
        --font-latin: 'Brittany Signature', cursive;
        --menu-bg: #E2D0AA;
        --menu-inactive: #AE7400;
        --menu-active: #956625;
        --btn-color: #ffffff;
      }
    </style>
  ...
  <body>
    <main id="app">
      ...
      <audio id="music" loop autoplay>
        <source src="https://assets.satumomen.com/musics/InstrumentalLaguJawa.mp3">
      </audio>
      <!-- end music -->
                  ...
                  <ul class="satumomen_list">
                    <li class="satumomen_slide satumomen_cover">
                      <div class="container-mobile cover"
                        style="background-image: url(https://satumomen.com/themes/wayang-kulit/bg.webp); ;">
                        <div class="frame">
                          <img class="frame-tl animate__animated animate__fadeInDown animate__slower"
                            src="https://satumomen.com/themes/wayang-kulit/frame-tm.webp" alt="frame" style="width: 100%">
                          <img class="frame-bl animate__animated animate__fadeInUp animate__slower"
                            src="https://satumomen.com/themes/wayang-kulit/frame-bm.webp" alt="frame" style="width: 100%">
                        </div>
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                          <div style="width: 100%">
                            <div class="animate__animated animate__fadeInDown animate__slower image-editable"
                              style="width: 70%;margin: auto;overflow: hidden;">
                              <img src="https://satumomen.com/themes/wayang-kulit/gunungan.webp"
                                style="width: 100%;height: 100%;object-fit: contain;"
                                class="animate__animated animate__pulse animate__infinite infinite animate__slower">
                            </div>
  
                            <div>
                              <div class="text-center animate__animated animate__fadeInDown animate__slower mb-5">
                                <div class="editable">Inaugurasi R.S. Bhayangkara TK.III</div>
                                <div class="editable font-accent color-accent h3" style="font-size: 30px;">Hasta Brata Batu</div>
                                <div class="editable">13 . 05 . 24</div>
                    ...
                    <li class="satumomen_slide">
                      <div class="container-mobile "
                        ...
                        <div
                          class="d-flex py-4 px-3 justify-content-center flex-column align-items-center justify-content-center"
                          style="height: 100%;overflow: hidden;background-color: var(--inv-border);border-radius: 1.5rem;">
                          <div
                            style="height: 100%;width: 80%;overflow: hidden;border-radius: 10rem;box-shadow: 0 14px 20px -10px rgb(0 0 0 / 63%);"
                            class="image-editable mx-auto mb-4 animate__animated animate__fadeInDown animate__slower">
                            <img src="assets.satumomen.com/images/galleries/27214-gallery-1671893993.jpg"
                          ...
                          <div style="width: 100%;">
                            ...
                            <div class="text-center animate__animated animate__fadeInUp animate__slower">
                              <div class="editable font-weight-bold mb-3" style="font-size: 14.4px;">Assalamu'alaikum Wr
                                Wb</div>
                              <div class="editable quotes" style="font-size: 14.4px;">Tanpa mengurangi rasa hormat, kami
                                bermaksud mengundang Bapak/Ibu/Saudara/i pada acara Inaugurasi R.S. Bhayangkara TK.III Hasta Brata Batu</div>
                    ...
                    <!-- <li class="satumomen_slide">
                      <div class="container-mobile "
                        ...
                        <div class="d-flex justify-content-center flex-column align-items-center justify-content-center"
                          ...
                          <div
                            style="height: 225px;width: 164px;overflow: hidden;border-radius: 10rem;box-shadow: 0 14px 20px -10px rgb(0 0 0 / 63%);"
                            class="image-editable mx-auto mb-4 animate__animated animate__fadeInDown animate__slower">
                            <img src="https://satumomen.com/themes/wayang-kulit/male.webp"
                              style="width: 100%;height: 100%;object-fit: cover;" draggable="false">
                          </div>
                          <div style="width: 100%;">
  
                            <div class="text-center animate__animated animate__fadeInUp animate__slower">
                              <div class="editable font-latin color-accent" style="font-size: 30px;">Ahmad</div>
                              <div class="editable font-accent h4 mb-3" style="font-size: 21.6px;">Novriyandi</div>
                              <div class="editable quotes" style="font-size: 14.4px;">Putra kedua<br>dari Bapak Indra
                                Jonaidi<br>dan Ibu Sabariah</div>
  
                            </div>
                            <div class="text-center">
                              <a href="https://instagram.com/" target="_blank"
                                class="link btn btn-primary rounded-pill my-3 animate__animated animate__fadeInUp animate__slower"
                                draggable="false" data-start="2022-08-27T02:09" data-end="2022-08-27T02:09">@instagram</a>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="container-mobile "
                        ...
                        <div class="d-flex justify-content-center flex-column align-items-center justify-content-center"
                          ...
                          <div
                            style="height: 225px;width: 164px;overflow: hidden;border-radius: 10rem;box-shadow: 0 14px 20px -10px rgb(0 0 0 / 63%);"
                            class="image-editable mx-auto mb-4 animate__animated animate__fadeInDown animate__slower">
                            <img src="https://satumomen.com/themes/wayang-kulit/female.webp"
                              style="width: 100%;height: 100%;object-fit: cover;" draggable="false" themes=""
                              wayang-kulit="">
                          </div>
                          <div style="width: 100%;">
  
                            <div class="text-center animate__animated animate__fadeInUp animate__slower">
                              <div class="editable font-latin color-accent " style="font-size: 30px;">Silvia</div>
                              <div class="editable font-accent h4 mb-3" style="font-size: 21.6px;">Angreini</div>
                              <div class="editable quotes" style="font-size: 14.4px;">Putri Bungsu<br>dari (Alm) Bapak
                                Erfan Ganef<br>dan Ibu Amoy Reflinda</div>
                    ...
                    <li class="satumomen_slide">
                      <div class="container-mobile "
                        ...
                        <div
                          class="d-flex p-3 justify-content-center flex-column align-items-center justify-content-center"
                          style="height: 100%;overflow: hidden;background-color: var(--inv-border);border-radius: 20rem 20rem 1.5rem 1.5rem;">
                          <div style="width: 100%;">
                            ...
                            <div class="text-center mb-3">
                              <div
                                class="editable font-accent color-accent h4 mb-2 animate__animated animate__fadeInDown animate__slower"
                                style="font-size: 30px;">Tanggal Peresmian</div>
                              <div
                                class="my-3 d-flex flex-row justify-content-center align-items-center animate__animated animate__zoomIn animate__slower">
                                <div class="editable" style="font-size: 14.4px;width: 100px;">Senin</div>
                                <div style="
      border-left: 2px solid var(--inv-accent);
      border-right: 2px solid var(--inv-accent);
  " class="px-3">
                                  <div class="editable" style="font-size: 38px; line-height: 1;">13</div>
                                  <div class="editable" style="font-size: 14.4px;">2024</div>
                                </div>
                                <div class="editable" style="font-size: 14.4px;width: 100px;">Mei</div>
                              </div>
                              <div class="editable animate__animated animate__fadeInDown animate__slower"
                                style="font-size: 14.4px;">Pukul 08:30 WIB ~ Selesai<br></div>
  
                            </div>
                            <div class="text-center">
                              <div
                                class="editable font-accent color-accent animate__animated animate__fadeInUp animate__slower"
                              ...
                              <div class="editable font-weight-bold animate__animated animate__fadeInUp animate__slower"
                                style="font-size: 14.4px;">Gedung Hiperbarik Hasta Brata Batu<br></div>
                              <div class="editable mb-4 animate__animated animate__fadeInUp animate__slower"
                                style="font-size: 14.4px;">Jl. Gajah Mada No.95, Ngaglik,<br>Kecamatan Batu - Kota
                                Batu</div>
                              <div
                                class="countdown-wrapper d-flex flex-column animate__animated animate__fadeInUp animate__slower"
                                data-datetime="2024-05-14T08:30">
                        ...
                        <div
                          ...
                          <div style="width: 100%;">
                            ...
                            <div class="text-center mb-3">
                              ...
                              <div
                                class="my-3 d-flex flex-row justify-content-center align-items-center animate__animated animate__zoomIn animate__slower">
                                <div class="editable" style="font-size: 14.4px;width: 100px;">Minggu</div>
                                <div style="
      border-left: 2px solid var(--inv-accent);
      border-right: 2px solid var(--inv-accent);
  " class="px-3">
                                  <div class="editable" style="font-size: 38px; line-height: 1;">04</div>
                                  <div class="editable" style="font-size: 14.4px;">2022</div>
                                </div>
                                <div class="editable" style="font-size: 14.4px;width: 100px;">Desember</div>
                              </div>
                              <div class="editable animate__animated animate__fadeInDown animate__slower"
                                style="font-size: 14.4px;">Pukul 14:00 WIB ~ 21.00 WIB<br></div>
                            ...
                            <div class="text-center">
                              <div
                                ...
                                style="font-size: 18px;">Lokasi Acara</div>
                              <div class="editable font-weight-bold animate__animated animate__fadeInUp animate__slower"
                                style="font-size: 14.4px;">Gedung Asrama Haji ( Arafah II )<br></div>
                              <div class="editable mb-4 animate__animated animate__fadeInUp animate__slower"
                                style="font-size: 14.4px;">Jl. Engku Putri, Teluk Tering<br>Kecamatan Batam Kota - Kota
                                Batam</div>
                              <div
                                class="countdown-wrapper d-flex flex-column animate__animated animate__fadeInUp animate__slower"
                                data-datetime="2023-10-30T08:00">
                                <div class="countdown text-center">
                                  <div class="countdown-item day">
                                    <div class="number">00</div>
                                    <div class="text editable">Hari</div>
  ...
  " class="animate__animated animate__fadeInDown animate__slow">
                                <!-- <iframe width="100%" height="100%" style="border:0;position: absolute;" loading="lazy"
                                  allowfullscreen=""
                                  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCpV55KNPo55TuxnDFd_dR3MD0luBrN1Gc&amp;zoom=17&amp;q=-3.326209785379272,114.5743439100617"
                                  class="maps-embed">
                                </iframe> -->
                                <iframe
                                  src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15808.94072354372!2d112.5247635!3d-7.8704416!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7881001fe71925%3A0x5337357bf01fe13!2sklinik%20hiperbarik!5e0!3m2!1sen!2sid!4v1715169947711!5m2!1sen!2sid"
                                  width="100%" height="100%" style="border:0;position: absolute;" allowfullscreen=""
                                  loading="lazy" referrerpolicy="no-referrer-when-downgrade"
                                  class="maps-embed"></iframe>></iframe>
                              </div>
                              <button class="btn-maps btn btn-sm btn-pilled btn-block btn-accent mt-1 mb-4" style="">Edit
                                Denah Lokasi</button>
                              <div class="text-center animate__animated animate__fadeInUp animate__slow">
  
                                <div class="editable font-weight-bold animate__animated animate__fadeInUp animate__slower"
                                  style="font-size: 14.4px;">Gedung Hiperbarik Hasta Brata Batu<br></div>
                                <div class="editable mb-3" style="font-size: 14.4px;">Jl. Gajah Mada No.95,
                                  Ngaglik,<br>Kecamatan Batu - Kota
                                  Batu</div>
                                <a href="https://www.google.com/maps/place/?q=-3.326209785379272,114.5743439100617"
                                  class="btn-maps-link btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow"
                                  target="_blank" draggable="false">Petunjuk Ke Lokasi</a>
                              </div>
                    ...
                    <li class="satumomen_slide">
                      <div class="container-mobile"
                        ...
                        <div
                          class="d-flex py-4 px-3 justify-content-center flex-column align-items-center justify-content-center"
                          style="height: 100%;background-color: var(--inv-border);border-radius: 1.5rem;">
                          <div
                            class="editable text-center font-latin color-accent h4 mb-4 animate__animated animate__fadeInDown animate__slower"
                            style="font-size: 28.8px;">Agenda Peresmian</div>
                          <div>
  
                            <!-- <div class="text-left pl-3 mb-3 animate__animated animate__fadeInUp animate__slower"
  ...
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">09.30 – 09.55
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Penyambutan PJU Polda dan Tamu
                                Undangan</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">09.55 – 10.00
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Kapolda tiba di gedung
                                Hiperbarik</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">10.00 – 10.05
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Peresmian nama Gedung
                                Hiperbarik</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">10.05 – 10.15
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Peninjauan Gedung Hiperbarik
                                dan Foto bersama di depan
                                Gedung Hiperbarik</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">10.15 – 10.20
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Kapolda bergeser menuju RSB.</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">10.20 – 10.30
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Presentasi 3D RSB masa depan.</div>
      ...
      transform: translateX(-24px) translateY(4px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">10.30 – 10.40</div>
                              <div class="editable quotes" style="font-size: 14.4px;">Penandatanganan prasasti masjid polres batu, faskes RS Bhayangkara Bondowoso, faskes RS Bhayangkara Lumajang fakes dan RS Bhayangkara Batu</div>
                    ...
                    <li class="satumomen_slide">
                      <div class="container-mobile"
                        ...
                        <div
                          ...
                          <div
                            class="editable text-center font-latin color-accent h4 mb-4 animate__animated animate__fadeInDown animate__slower"
                            style="font-size: 28.8px;">Agenda Lanjutan</div>
                          <div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">10.40 – 10.50
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Penandatanganan Prasasti</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">10.55 – 11.05
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Penyerahan tali asih kepada 
                                pasien lansia dan anak yatim</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">11.05 – 11.15
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Peninjauan Baktikes dan UMKM</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">11.15 – 12.00
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Sambutan.</div>
      ...
      transform: translateX(-24px) translateY(4px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">12.00– Selesai</div>
                              <div class="editable quotes" style="font-size: 14.4px;">Ramah tamah dengan masyarakat Batu</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">10.25 – 10.30
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Presentasi 3D RSB masa depan</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">10.30– 10.40 
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Peninjauan RSB</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">10.50 – 11.00
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Penyerahan bingkisan kepada 
                                pasien lansia dan anak yatim</div>
  ...
  "></span>
      ...
      transform: translateX(-17px) translateY(20px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">11.00 – 11.10
                              </div>
                              <div class="editable quotes" style="font-size: 14.4px;">Peninjauan Baktikes dan UMKM</div>
      ...
      transform: translateX(-24px) translateY(4px);
  "></span>
                              <div class="editable font-weight-bold mb-2" style="font-size: 14.4px;">10.20– 10.25</div>
                              <div class="editable quotes" style="font-size: 14.4px;">Penyambutan dengan Senam
                                Lansia dan Hadrah</div>
                    ...
                    <!-- <li class="satumomen_slide">
                      <div class="container-mobile "
                        ...
                        <div
                          class="d-flex p-3 pb-4 justify-content-center flex-column align-items-center justify-content-center"
                          style="height: 100%;overflow: hidden;background-color: var(--inv-border);border-radius: 1.5rem;">
                          <div style="height: 100%;width: 100%;overflow: hidden;border-radius: 1rem;"
                            class="image-editable mb-4 mx-auto animate__animated animate__fadeInDown animate__slower">
                            <img src="themes/rounded-luxurious/guest-book.jpg"
                              style="width: 100%;height: 100%;object-fit: cover;" draggable="false">
                          </div>
                          <div class="text-center mb-4 animate__animated animate__fadeInUp animate__slower">
                            <div class="editable font-accent font-weight-bold mb-3" style="font-size: 30px;">Guest Book
                            </div>
                            <div class="editable" style="font-size: 14px;">Kirim do'a dan ucapan anda serta<br>konfirmasi
                              kehadiran dengan klik tombol<br>dibawah ini</div>
                          </div>
                          <button type="button"
                            class="btn-rsvp btn btn-primary rounded-pill mb-auto animate__animated animate__fadeInUp animate__slow">Konfirmasi
                            &amp; Kirim Ucapan</button>
                        </div>
                      </div>
                    </li> -->
                    <li class="satumomen_slide">
                      <div class="container-mobile "
                        ...
                        <div
                          ...
                          <div style="height: 100%;width: 100%;overflow: hidden;border-radius: 1rem;"
                            class="image-editable mb-4 mx-auto animate__animated animate__fadeInDown animate__slower">
                            <img src="assets.satumomen.com/images/galleries/27214-gallery-1671893993.png"
                              style="width: 100%;height: 100%;object-fit: cover;" draggable="false">
                          </div>
                          <div class="text-center mb-4 animate__animated animate__fadeInUp animate__slower">
                            <div class="editable font-accent font-weight-bold mb-3" style="font-size: 30px;">Live
                              Streaming</div>
                            <div class="editable" style="font-size: 14px;">Saksikan peresmian gedung kami secara virtual melalui
                               live streaming dengan klik link berikut</div>
                          </div>
                          <a href="https://instagram.com/" target="_blank"
                            class="link btn btn-primary rounded-pill mb-3 animate__animated animate__fadeInUp animate__slow"
                            draggable="false">Join Live Streaming</a>
                          <!-- <div class="editable text-center animate__animated animate__fadeInUp animate__slower"
                            style="font-size: 14.4px;">Instagram : @mempelai<br>Zoom Meeting ID : 123456789<br>Password :
                            Rahasia</div> -->
                        </div>
                      </div>
                    </li>
  ...
  ">
      ...
      padding-bottom: 57%;
      position: relative;
  " class="embed-video animate__animated animate__fadeInDown animate__slower"><iframe width="560" height="315"
                                  src="https://www.youtube.com/embed/r-ktGwuK4sc" title="YouTube video player"
                                  frameborder="0"
                                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                  allowfullscreen=""></iframe></div>
                              <button class="btn-video btn btn-sm btn-pilled btn-block btn-accent mt-1 mb-4" style="">Edit
                                Video</button>
                              <div style="
      display: grid;
      ...
      gap: 8px;
  ">
                                <div class="light rounded-lg animate__animated animate__zoomIn animate__slower"
                                ...
                                <div class="light rounded-lg animate__animated animate__zoomIn animate__slower"
                                  style="overflow: hidden;grid-column: 2 / -1;height: 100px;">
                                  <img src="assets.satumomen.com/images/galleries/24167-gallery-1668428983.jpg"
                                    style="width: 100%;height: 100%;object-fit: cover;" class="lightbox"
                                    draggable="false">
                                </div>
                                <div class="light rounded-lg animate__animated animate__zoomIn animate__slower"
                                  style="overflow: hidden;height: 100px;grid-column: 1 / span 2;">
                                  <img src="assets.satumomen.com/images/galleries/24167-gallery-1668428887.jpg"
                                    style="width: 100%;height: 100%;object-fit: cover;" class="lightbox"
                                    draggable="false">
                                </div>
                                <div class="light rounded-lg animate__animated animate__zoomIn animate__slower"
                                  style="overflow: hidden;height: 100px;">
                                  <img src="assets.satumomen.com/images/galleries/24167-gallery-1668429551.jpg"
                                    style="width: 100%;height: 100%;object-fit: cover;" class="lightbox"
                                    draggable="false">
                                </div>
                              </div>
                        ...
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%; ">
                          <div style="width: 100%;" class="text-center">
                            <div
                              ...
                              style="font-size: 28.8px;">Send GIft</div>
                            <div class="editable mb-4 animate__animated animate__fadeInDown animate__slower"
                              style="font-size: 14.4px;">Thank you for adding to the joyful spirit of our wedding with
                              your presence and lovely gift.</div>
                            <div style="
      display: flex;
  ">
                              <button type="button"
                              ...
                              <button type="button"
                                class="btn-gift btn btn-block btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow"
                                style="max-width: 150px; margin: auto; font-size: 14.4px;">🎁 Wedding Gift</button>
                            </div>
                            <div class="gift-container mt-3 p-4 rounded animate__animated animate__zoomIn animate__slow"
                              style="
  ">
                              <div
                                style="height: 69px;width: 100%;max-width: 150px;margin: auto;overflow: hidden;margin-bottom: 20px;border-radius: 10px;"
                                class="image-editable">
                                <img src="https://assets.satumomen.com/images/galleries/20568-gallery-1666961009.webp"
  ...
  ">
                              <div class="text-center mb-2">
                                ...
                                <div class="editable mb-0">Anda dapat mengirim kado ke:<br>Jl. Wildan Sari 1 No 11
                        ...
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                          <div style="width: 100%;">
                            <div class="text-center mb-4 animate__animated animate__fadeInDown animate__slower">
                              <div class="color-accent font-latin h4 mb-2 editable" style="font-size: 28.8px;">Our
                                Memories</div>
                            </div>
                            <div style="
      display: grid;
  ...
  ">
                              <div class="light rounded-lg animate__animated animate__zoomIn animate__slower"
                                style="overflow: hidden;height: 100px;">
                                <img src="assets.satumomen.com/images/galleries/27214-gallery-1671893993.jpg"
                                  style="width: 100%;height: 100%;object-fit: cover;" class="lightbox" draggable="false">
                              </div>
                              ...
                              <div class="light rounded-lg animate__animated animate__zoomIn animate__slower"
                                style="overflow: hidden;height: 100px;grid-column: 2 / -1;">
                                <img src="assets.satumomen.com/images/galleries/24167-gallery-1668429551.jpg"
                                  style="width: 100%;height: 100%;object-fit: cover;" class="lightbox" draggable="false">
                              </div>
                              <div class="light rounded-lg animate__animated animate__zoomIn animate__slower"
                        ...
                        <div
                          ...
                          <div width="100%">
                            ...
                            <div class="editable mb-4 text-center animate__animated animate__fadeInUp animate__slower"
                              style="font-size: 14.4px;">Hubungi Contact Person kami jika ada hal<br>yang ingin
                              ditanyakan.</div>
  
                            <div class="text-center animate__animated animate__fadeInUp animate__slower mb-4">
                              <div
                                class="image-editable animate__animated animate__fadeInUp animate__slower rounded-circle"
                                style="height: 80px;width: 80px;margin: auto;overflow: hidden;margin-bottom: 10px;">
                                <img src="https://satumomen.com/themes/wayang-kulit/male.webp"
                                  style="width: 100%;height: 100%;object-fit: cover;" draggable="false">
                              </div>
                              <div
                                class="editable font-accent color-accent h4 mb-2 animate__animated animate__fadeInUp animate__slower"
                                style="font-size: 16px;">dr. Yeremia</div>
                              <a class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower"
                                href="https://wa.me/6281250335095" target="_blank" draggable="false">WA 0822-5702-6517</a>
                            </div>
                            <div class="text-center animate__animated animate__fadeInUp animate__slower">
                              <div
                                class="image-editable animate__animated animate__fadeInUp animate__slower  rounded-circle"
                              ...
                              <div
                                class="editable font-accent color-accent h4 mb-2 animate__animated animate__fadeInUp animate__slower"
                                style="font-size: 16px;">Sri Wahyuni</div>
                              <a class="link btn btn-primary rounded-pill animate__animated animate__fadeInUp animate__slower"
                                href="https://wa.me/6281250335095" target="_blank" draggable="false">WA 0821-4277-5565</a>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%; width: 100%;">
                          <div>
                            <div class="text-center">
                              ...
                              <div class="editable px-5 mb-4 animate__animated animate__fadeInUp animate__slower"
                                style="font-size: 14.4px;">Mengingat kondisi pandemi saat ini, kami menghimbau
                                Bapak/Ibu/Saudara/i tamu undangan agar tetap memperhatikan protokol kesehatan dalam rangka
                                upaya pencegahan penyebaran virus Covid-19.</div>
                            </div>
  ...
  ">
                    ...
                    <li class="satumomen_slide">
                      <div class="container-mobile "
                        ...
                        <div class="watermark p-3 d-flex justify-content-center align-items-center" style="
      height: 100%;
  ...
  ">
                          <div swtyle="width: 100%">
                            <div class="text-center">
                              <img src="images/LOGO.png" height="120px" alt="" class='mb-3 animate__animated animate__fadeInDown animate__slower'>
                              <div class="editable quotes mb-3 animate__animated animate__fadeInDown animate__slower"
                                style="font-size: 14.4px;">Merupakan suatu kebahagiaan bagi kami atas kehadiran Bapak/Ibu
                              </div>
                              <div class="editable font-italic animate__animated animate__fadeInDown animate__slow"
                                style="font-size: 14.4px;">Hormat Kami</div>
  
                              <div
                                class="editable font-accent h4 color-accent animate__animated animate__fadeInDown animate__slow"
                                style="font-size: 21.6px;">RS HASTA BRATA BATU</div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content" style="height:100%">
            ...
            <button onclick="closeModal(qrModal)" type="button" class="btn btn-close"><svg
                xmlns="http://www.w3.org/2000/svg" height="42px" width="42px" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content p-4" style="height:100%">
            ...
            <rsvp-component
              ...
              :invitation_id="28004" name="Nama Tamu" code="#" overlay="1"></rsvp-component>
        ...
        <div class="modal-content" style="border-radius: .8rem;">
          <div class="modal-body text-center justify-content-center align-items-center">
            ...
            <p>Browser yang kamu gunakan mungkin kurang kompatibel. Beberapa fungsi undangan ini mungkin tidak dapat
              berjalan dengan baik. Kami merekomendasikan Chrome. Klik tombol dibawah ini untuk mendownload.</p>
          ...
          <div class="modal-footer">
            <button class="btn btn-outline-secondary btn-block rounded-pill" onclick="closeModal(notSupport)">Tetap
              Akses</button>
          </div>
        </div>
      </div>
    ...
    <!-- start script -->
    <!-- <script src="js/app8603.js?v=080340"></script> -->
    <script src="themes/themesv28603.js?v=080340"></script>
    <script>
    ...
    <!-- <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vedd3670a3b1c4e178fdfb0cc912d969e1713874337387"
      ...
      data-cf-beacon='{"rayId":"8808e8a60feb1075","version":"2024.4.1","r":1,"token":"bb94421b81454f668eb9cf5cf8e9f0cb","b":1}'
      crossorigin="anonymous"></script> -->
  </body>
  
  
  <!-- Mirrored from satumomen.com/preview/wayang-kulit by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 May 2024 10:54:03 GMT -->
